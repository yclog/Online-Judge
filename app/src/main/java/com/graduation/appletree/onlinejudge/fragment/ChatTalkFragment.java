...
public class ChatTalkFragment extends BaseFragment{
    ...
    private List<RVChatTalkData> getDataList(){
        ...
        mDataList.add(new RVChatTalkData(1, R.drawable.avatar_five, 0, "小明", "下午一起吃肉", "20:58"));
        mDataList.add(new RVChatTalkData(2, R.drawable.avatar_nine, 2, "小白", "什么时候去旅游", "18:23"));
        mDataList.add(new RVChatTalkData(3, R.drawable.avatar_six, 1, "SpritCan", "病好了没", "10:15"));
        mDataList.add(new RVChatTalkData(4, R.drawable.avatar_four, 1, "蘑菇", "明天拍毕业照", "12:29"));
        mDataList.add(new RVChatTalkData(4, R.drawable.avatar_eight, 1, "二哈", "我的代码有bug", "yesterday"));
        return mDataList;
    }
}
